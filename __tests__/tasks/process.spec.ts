import { ProcessTaskFactory } from '@src/tasks/process/index.js'
...
describe('ProcessTask', () => {
  describe('module does not exist', () => {
    it('throws FatalError', async () => {
      const factory = new ProcessTaskFactory(getFixturePath('not-exist.js'))
  ...
  , 'esm/bad.js'
    ...
    it('throws FatalError', async () => {
      const factory = new ProcessTaskFactory(getFixturePath(filename))
      const task = factory.create()
